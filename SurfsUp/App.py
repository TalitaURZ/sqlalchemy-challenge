...
# reflect an existing database into a new model - use auto_base
Base = automap_base()

# reflect the tables - use Base.prepare
#SQLAlchemy inspects the database and creates representation of the tables 
# as ORM classes.
Base.prepare(autoload_with=engine)

# Save references to each table -is a reference to the table in the database that
# was automatically mapped by the ORM class created from the Base class
